...
<head>
    <meta charset="UTF-8">
    <title>Grooming Product - EasyShop</title>
    <link rel="icon" type="image/png" href="images/logo2.jpg">
    <link rel="stylesheet" href="grooming.css"> <!-- Reuse styling -->
...
$current_category = "grooming"; // Set category to 'fashion'
