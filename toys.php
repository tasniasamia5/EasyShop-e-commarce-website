...
<head>
    ...
    <link rel="stylesheet" href="toys.css"> <!-- Reuse styling -->
    <link rel="stylesheet" href="style.css">   <!-- Global style and header -->
</head>
<body>
...
$current_category = "Toys"; // Set category to 'fashion'
